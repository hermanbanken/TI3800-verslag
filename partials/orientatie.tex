...
\centering
\subfigure[Strava]{
    \includegraphics[height=4cm]{style/images/Strava}
    \label{fig:strava}
}
\subfigure[RunKeeper]{
    \includegraphics[height=4cm]{style/images/RunKeeper}
    \label{fig:runkeeper}
}
\subfigure[MyLaps Practice]{
    \includegraphics[height=4cm]{style/images/MyLapsPractice}
    \label{fig:mylapspractice}
}
\subfigure[Coach Watch]{
    \includegraphics[height=4cm]{style/images/CoachWatch}
